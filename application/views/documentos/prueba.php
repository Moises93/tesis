...
<img src="images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="<?php echo base_url();?>application/libraries/tcpdf/examples/images/tcpdf_box.svg" alt="test alt attribute" width="100" height="100" border="0" /><img src="images/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
$html .= "<strong>ejeleeeee" . $ide['id'] . "</strong>";

 foreach ($ide as $fila)
    {
   $id = $fila['id'];
   $html .= "<strong>ejeleeeee" . $id . "</strong>";
}
